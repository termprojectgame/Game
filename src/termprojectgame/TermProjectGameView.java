 ...
 */
public class TermProjectGameView extends FrameView {

    public TermProjectGameView(SingleFrameApplication app) {
        super(app);
    ...
    public void showAboutBox() {
        if (aboutBox == null) {
            JFrame mainFrame = TermProjectGameApp.getApplication().getMainFrame();
            aboutBox = new TermProjectGameAboutBox(mainFrame);
            aboutBox.setLocationRelativeTo(mainFrame);
        }
        TermProjectGameApp.getApplication().show(aboutBox);
    }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(termprojectgame.TermProjectGameApp.class).getContext().getResourceMap(TermProjectGameView.class);
